...
function gotResults(error, results)
{
    ...
    } else
    {
        ...
        animal_image = document.getElementById('https://shravaripatil.github.io/Sound_controlled_animals/listen.gif');
        ...
        {
            animal_image = 'wael-tsar-clapping.gif';

        } 
        else (results[0].label == "Snap")
        {
            animal_image = 'snap-bob-marley.gif';
